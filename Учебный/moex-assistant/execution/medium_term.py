...
from core.config import PAPER_TRADING, TINKOFF_SANDBOX, should_auto_trade
from core import db
...
async def run_medium_term_proposals(
    ...
    for horizon in (3, 7):
        ...
        for p in preds:
            ...
            proposal_confidence = 70 if p.get("predicted_strength") == "strong" else 60
            if proposal_mode == "semi_auto" and should_auto_trade(proposal_confidence):
